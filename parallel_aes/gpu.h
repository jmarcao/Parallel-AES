...
namespace PAES {
    namespace GPU {
		...
		// Expands the input key on the host, since this is only done once per key
		__host__ void expandKey(const AESType& flavor, uint8_t* ogkey, uint8_t* expkey, uint32_t keysize, uint32_t num_rounds);

		// Helper Functions for key expansion, just done on host
		...
		// NOTE: If data is stored in row-major, this becomes more efficient since one row
		// will fit in the block of L1 cache nicely.
		...
		// TABLES
		// Substitution 
		__constant__ static const uint8_t c_sbox[256] = {
		...
		__constant__ static const uint8_t c_rsbox[256] = {
		...
		__constant__ static const uint8_t c_mul9[] = {
		...
		__constant__ static const uint8_t c_mulB[] = {
		...
		__constant__ static const uint8_t c_mulD[] = {
		...
		__constant__ static const uint8_t c_mulE[] = {
